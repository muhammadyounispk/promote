...
Route::group(['prefix' => 'user', 'as' => 'user.', 'middleware' => ['auth','user','saas']], function (){
   ...
   Route::get('/sent-text-message',                [USER\CustomTextController::class,'index'])->name("marketing_job");
   Route::get('/sent-text-message/check_job',                [USER\CustomTextController::class,'check_job'])->name("check_job");
   ...
   // CONTRACT
    Route::post('/upload_contract',  [USER\BulkController::class,'upload_contract'])->name('upload_contract');
    Route::get('/runCompains',  [USER\BulkController::class,'runCompains'])->name('runCompains');
    Route::post('/Process/device/{id?}',  [USER\BulkController::class,'Process'])->name('Process');
    Route::get('/Process/check_status/{device_id?}/{contract_id?}',  [USER\BulkController::class,'checkStatus'])->name('checkStatus');
    Route::get('/Process/checkStatusbyContract/{contract_id?}',  [USER\BulkController::class,'checkStatusbyContract'])->name('checkStatusbyContract');
