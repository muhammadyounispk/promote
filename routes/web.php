...
Route::group(['prefix' => 'cron', 'as' => 'cron.'], function (){
    ...
    Route::get('/execute_jobs/{id}', [App\Http\Controllers\CronController::class, 'execute_jobs']);
    Route::get('/execute_all_users_jobs', [App\Http\Controllers\CronController::class, 'execute_all_users_jobs']);
